...
# custom throbber
RUN sed -i 's/Kibana/Gotbot Reports/g' /usr/share/kibana/src/core_plugins/kibana/translations/en.json
...
RUN sed -i 's/title Kibana/title Gotbot Reports/g' /usr/share/kibana/src/ui/ui_render/views/chrome.jade
